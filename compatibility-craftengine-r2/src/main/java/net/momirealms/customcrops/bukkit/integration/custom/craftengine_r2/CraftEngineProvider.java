...
package net.momirealms.customcrops.bukkit.integration.custom.craftengine_r2;
...
public class CraftEngineProvider implements CustomItemProvider {
    ...
    public @Nullable Entity placeFurniture(Location location, String id) {
        BukkitFurniture furniture = CraftEngineFurniture.place(LocationUtils.toSurfaceCenterLocation(location), Key.of(id), AnchorType.GROUND.variantName());
